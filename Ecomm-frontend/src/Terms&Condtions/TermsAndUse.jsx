    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, Atrangi.com.
        </p>
        <p>
        ...
        <p>
          ...
          agreed to or set forth in writing by Atrangi, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to Atrangi's acceptance. This means
          Atrangi may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, Atrangi
        ...
        <p>
          ...
          and it is accepted by Atrangi. Prices for products displayed on
          ...
          website may differ from those in stores that stock Atrangi
          products, as these stores are independent of Atrangi.
          Atrangi reserves the right to amend pricing for any pricing
          ...
          submitted an online order, Atrangi will notify you of the error
        ...
        <p>
          ...
          Atrangi reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse Atrangi if it pays, any
          taxes, except for those based on Atrangi's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by Atrangi for when the
          ...
          are beyond our control. Atrangi cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by Atrangi, customer
          may not cancel such accepted order without Atrangi’s prior
          ...
          expenses. The product(s) must be returned to Atrangi within
        ...
        <p>
          ...
          indemnify and hold Atrangi harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>Atrangi</p>
        <p style={{ fontWeight: "500" }}>123 Main Street, City, Country</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@Atrangi.com</span>
        </p>
      </div>
    </div>
  );
