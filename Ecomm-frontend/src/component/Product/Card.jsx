...
const MyCard = ({ review }) => {
  ...
  return (
    <div style={classes.cardRoot}>
      ...
      <Typography variant="body1" style={classes.commentTxt}>
        {review.comment}
      </Typography>
      <Typography variant="body1" style={classes.recommend}>
        Would you recommend this product?{" "}
        <span style={review.recommend ? classes.yes : classes.no}>
